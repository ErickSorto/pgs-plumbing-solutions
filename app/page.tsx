...
const gallery = [
  {
    image: "/pgs/pgs-laundry-copper-lines.webp",
    enTitle: "Laundry rough-in",
    esTitle: "Instalación para lavandería",
    enDetail: "Real PGS project photo",
    esDetail: "Foto real de proyecto PGS",
    enAlt: "Copper laundry plumbing rough-in behind a washing machine",
    esAlt: "Instalación de tubería de cobre para lavandería detrás de una lavadora",
  },
  {
    image: "/pgs/pgs-water-heater-install.webp",
    enTitle: "Water heater install",
    esTitle: "Instalación de calentador",
    enDetail: "Real PGS project photo",
    esDetail: "Foto real de proyecto PGS",
    enAlt: "Installed water heater with copper piping in a basement utility room",
    esAlt: "Calentador de agua instalado con tubería de cobre en cuarto de servicios",
  },
  {
    image: "/pgs/pgs-bathtub-rough-in.webp",
    enTitle: "Bath remodel plumbing",
    esTitle: "Plomería para baño",
    enDetail: "Real PGS project photo",
    esDetail: "Foto real de proyecto PGS",
    enAlt: "Bathtub remodel plumbing rough-in with exposed wall framing",
    esAlt: "Instalación de plomería para bañera con estructura de pared expuesta",
  },
  {
    image: "/pgs/pgs-clawfoot-tub-supply-lines.webp",
    enTitle: "Tub supply lines",
    esTitle: "Líneas para bañera",
    enDetail: "Real PGS project photo",
    esDetail: "Foto real de proyecto PGS",
    enAlt: "Copper supply lines installed below a clawfoot bathtub",
    esAlt: "Líneas de suministro de cobre instaladas debajo de una bañera",
  },
  {
